...
import PaymentInfoChartIcon from "../../../assest/icons/payment-info-chart";
...
const data = [
  ...
  { month: "Sep", area: 65, line: 50 },
  { month: "Oct", area: 80, line: 75 },
  { month: "Nov", area: 30, line: 20 },
  { month: "Dec", area: 90, line: 40 },
];

const PaymentInfoChart: React.FC = () => {
  return (
    <div className="w-full mx-auto bg-white py-7 px-5 border border-primary-border rounded-primary flex flex-col gap-5">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-bold !font-family-barlow flex items-center gap-2">
          <PaymentInfoChartIcon className="h-6 w-6" />
          Total Spending
        </h2>
        <div className="w-28">
          <FormSelect
