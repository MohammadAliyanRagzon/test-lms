        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-base">Teaches Chemistry</p>
      ...
      <div className=" flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <div className="rounded-sm border border-gray-200 py-2.5 px-3.5 flex items-center gap-2.5 flex-wrap">
            <Chip children="Metric | English" />
            <Chip children="Metric | Mathematics" />
            <Chip children="Metric | Physics" />
            <Chip children="FSc Pre Eng. | English" />
            <Chip children="FSc Pre Eng. | Maths" />
          </div>
        </div>
        <div className="flex flex-col gap-2.5">
          <h1 className="!font-family-barlow font-bold text-xl">Courses</h1>
          <div className="rounded-sm border border-gray-200 py-2.5 px-3.5 flex items-center gap-2.5 flex-wrap">
            <Chip children="Shopify" />
            <Chip children="WordPress" />
            <Chip children="Mobile Development" />
            <Chip children="Video Editing" />
          </div>
        </div>
        <div className="flex flex-col gap-2.5">
